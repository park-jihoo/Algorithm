class Solution {
    public int makeArrayIncreasing(int[] arr1, int[] arr2) {
        ...
        // dp[i][j] : for the index of j - 1 in arr1, if we changed i times and then maintain a strickly increasing array from 0 to j , the minimal value for index of j is dp[i][j](we want to make the front numbers as small as possible); 
